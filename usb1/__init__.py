...
__all__ = [
    ...
    'BT_PLATFORM_DESCRIPTOR_MIN_SIZE',
    'BT_SSPLUS_USB_DEVICE_CAPABILITY_SIZE',
...
# Public aliases for the low-level libusb constants.
CLASS_PER_INTERFACE: Final = libusb1.LIBUSB_CLASS_PER_INTERFACE
CLASS_AUDIO: Final = libusb1.LIBUSB_CLASS_AUDIO
CLASS_COMM: Final = libusb1.LIBUSB_CLASS_COMM
CLASS_HID: Final = libusb1.LIBUSB_CLASS_HID
CLASS_PHYSICAL: Final = libusb1.LIBUSB_CLASS_PHYSICAL
CLASS_PRINTER: Final = libusb1.LIBUSB_CLASS_PRINTER
CLASS_PTP: Final = libusb1.LIBUSB_CLASS_PTP
CLASS_MASS_STORAGE: Final = libusb1.LIBUSB_CLASS_MASS_STORAGE
CLASS_HUB: Final = libusb1.LIBUSB_CLASS_HUB
CLASS_DATA: Final = libusb1.LIBUSB_CLASS_DATA
CLASS_SMART_CARD: Final = libusb1.LIBUSB_CLASS_SMART_CARD
CLASS_CONTENT_SECURITY: Final = libusb1.LIBUSB_CLASS_CONTENT_SECURITY
CLASS_VIDEO: Final = libusb1.LIBUSB_CLASS_VIDEO
CLASS_PERSONAL_HEALTHCARE: Final = libusb1.LIBUSB_CLASS_PERSONAL_HEALTHCARE
CLASS_DIAGNOSTIC_DEVICE: Final = libusb1.LIBUSB_CLASS_DIAGNOSTIC_DEVICE
CLASS_WIRELESS: Final = libusb1.LIBUSB_CLASS_WIRELESS
CLASS_APPLICATION: Final = libusb1.LIBUSB_CLASS_APPLICATION
CLASS_VENDOR_SPEC: Final = libusb1.LIBUSB_CLASS_VENDOR_SPEC
CLASS_IMAGE: Final = libusb1.LIBUSB_CLASS_IMAGE
DT_DEVICE: Final = libusb1.LIBUSB_DT_DEVICE
DT_CONFIG: Final = libusb1.LIBUSB_DT_CONFIG
DT_STRING: Final = libusb1.LIBUSB_DT_STRING
DT_INTERFACE: Final = libusb1.LIBUSB_DT_INTERFACE
DT_ENDPOINT: Final = libusb1.LIBUSB_DT_ENDPOINT
DT_HID: Final = libusb1.LIBUSB_DT_HID
DT_REPORT: Final = libusb1.LIBUSB_DT_REPORT
DT_PHYSICAL: Final = libusb1.LIBUSB_DT_PHYSICAL
DT_HUB: Final = libusb1.LIBUSB_DT_HUB
DT_DEVICE_SIZE: Final = libusb1.LIBUSB_DT_DEVICE_SIZE
DT_CONFIG_SIZE: Final = libusb1.LIBUSB_DT_CONFIG_SIZE
DT_INTERFACE_SIZE: Final = libusb1.LIBUSB_DT_INTERFACE_SIZE
DT_ENDPOINT_SIZE: Final = libusb1.LIBUSB_DT_ENDPOINT_SIZE
DT_ENDPOINT_AUDIO_SIZE: Final = libusb1.LIBUSB_DT_ENDPOINT_AUDIO_SIZE
DT_HUB_NONVAR_SIZE: Final = libusb1.LIBUSB_DT_HUB_NONVAR_SIZE
DT_SS_ENDPOINT_COMPANION_SIZE: Final = libusb1.LIBUSB_DT_SS_ENDPOINT_COMPANION_SIZE
DT_BOS_SIZE: Final = libusb1.LIBUSB_DT_BOS_SIZE
DT_DEVICE_CAPABILITY_SIZE: Final = libusb1.LIBUSB_DT_DEVICE_CAPABILITY_SIZE
DT_INTERFACE_ASSOCIATION_SIZE: Final = libusb1.LIBUSB_DT_INTERFACE_ASSOCIATION_SIZE
BT_USB_2_0_EXTENSION_SIZE: Final = libusb1.LIBUSB_BT_USB_2_0_EXTENSION_SIZE
BT_SS_USB_DEVICE_CAPABILITY_SIZE: Final = libusb1.LIBUSB_BT_SS_USB_DEVICE_CAPABILITY_SIZE
BT_SSPLUS_USB_DEVICE_CAPABILITY_SIZE: Final = libusb1.LIBUSB_BT_SSPLUS_USB_DEVICE_CAPABILITY_SIZE
BT_CONTAINER_ID_SIZE: Final = libusb1.LIBUSB_BT_CONTAINER_ID_SIZE
BT_PLATFORM_DESCRIPTOR_MIN_SIZE: Final = libusb1.LIBUSB_BT_PLATFORM_DESCRIPTOR_MIN_SIZE
DT_BOS_MAX_SIZE: Final = libusb1.LIBUSB_DT_BOS_MAX_SIZE
ENDPOINT_ADDRESS_MASK: Final = libusb1.LIBUSB_ENDPOINT_ADDRESS_MASK
ENDPOINT_DIR_MASK: Final = libusb1.LIBUSB_ENDPOINT_DIR_MASK
ENDPOINT_IN: Final = libusb1.LIBUSB_ENDPOINT_IN
ENDPOINT_OUT: Final = libusb1.LIBUSB_ENDPOINT_OUT
TRANSFER_TYPE_MASK: Final = libusb1.LIBUSB_TRANSFER_TYPE_MASK
TRANSFER_TYPE_CONTROL: Final = libusb1.LIBUSB_TRANSFER_TYPE_CONTROL
TRANSFER_TYPE_ISOCHRONOUS: Final = libusb1.LIBUSB_TRANSFER_TYPE_ISOCHRONOUS
TRANSFER_TYPE_BULK: Final = libusb1.LIBUSB_TRANSFER_TYPE_BULK
TRANSFER_TYPE_INTERRUPT: Final = libusb1.LIBUSB_TRANSFER_TYPE_INTERRUPT
REQUEST_GET_STATUS: Final = libusb1.LIBUSB_REQUEST_GET_STATUS
REQUEST_CLEAR_FEATURE: Final = libusb1.LIBUSB_REQUEST_CLEAR_FEATURE
REQUEST_SET_FEATURE: Final = libusb1.LIBUSB_REQUEST_SET_FEATURE
REQUEST_SET_ADDRESS: Final = libusb1.LIBUSB_REQUEST_SET_ADDRESS
REQUEST_GET_DESCRIPTOR: Final = libusb1.LIBUSB_REQUEST_GET_DESCRIPTOR
REQUEST_SET_DESCRIPTOR: Final = libusb1.LIBUSB_REQUEST_SET_DESCRIPTOR
REQUEST_GET_CONFIGURATION: Final = libusb1.LIBUSB_REQUEST_GET_CONFIGURATION
REQUEST_SET_CONFIGURATION: Final = libusb1.LIBUSB_REQUEST_SET_CONFIGURATION
REQUEST_GET_INTERFACE: Final = libusb1.LIBUSB_REQUEST_GET_INTERFACE
REQUEST_SET_INTERFACE: Final = libusb1.LIBUSB_REQUEST_SET_INTERFACE
REQUEST_SYNCH_FRAME: Final = libusb1.LIBUSB_REQUEST_SYNCH_FRAME
REQUEST_TYPE_STANDARD: Final = libusb1.LIBUSB_REQUEST_TYPE_STANDARD
REQUEST_TYPE_CLASS: Final = libusb1.LIBUSB_REQUEST_TYPE_CLASS
REQUEST_TYPE_VENDOR: Final = libusb1.LIBUSB_REQUEST_TYPE_VENDOR
REQUEST_TYPE_RESERVED: Final = libusb1.LIBUSB_REQUEST_TYPE_RESERVED
TYPE_STANDARD: Final = libusb1.LIBUSB_TYPE_STANDARD
TYPE_CLASS: Final = libusb1.LIBUSB_TYPE_CLASS
TYPE_VENDOR: Final = libusb1.LIBUSB_TYPE_VENDOR
TYPE_RESERVED: Final = libusb1.LIBUSB_TYPE_RESERVED
RECIPIENT_DEVICE: Final = libusb1.LIBUSB_RECIPIENT_DEVICE
RECIPIENT_INTERFACE: Final = libusb1.LIBUSB_RECIPIENT_INTERFACE
RECIPIENT_ENDPOINT: Final = libusb1.LIBUSB_RECIPIENT_ENDPOINT
RECIPIENT_OTHER: Final = libusb1.LIBUSB_RECIPIENT_OTHER
ISO_SYNC_TYPE_MASK: Final = libusb1.LIBUSB_ISO_SYNC_TYPE_MASK
ISO_SYNC_TYPE_NONE: Final = libusb1.LIBUSB_ISO_SYNC_TYPE_NONE
ISO_SYNC_TYPE_ASYNC: Final = libusb1.LIBUSB_ISO_SYNC_TYPE_ASYNC
ISO_SYNC_TYPE_ADAPTIVE: Final = libusb1.LIBUSB_ISO_SYNC_TYPE_ADAPTIVE
ISO_SYNC_TYPE_SYNC: Final = libusb1.LIBUSB_ISO_SYNC_TYPE_SYNC
ISO_USAGE_TYPE_MASK: Final = libusb1.LIBUSB_ISO_USAGE_TYPE_MASK
ISO_USAGE_TYPE_DATA: Final = libusb1.LIBUSB_ISO_USAGE_TYPE_DATA
ISO_USAGE_TYPE_FEEDBACK: Final = libusb1.LIBUSB_ISO_USAGE_TYPE_FEEDBACK
ISO_USAGE_TYPE_IMPLICIT: Final = libusb1.LIBUSB_ISO_USAGE_TYPE_IMPLICIT
CONTROL_SETUP_SIZE: Final = libusb1.LIBUSB_CONTROL_SETUP_SIZE
SPEED_UNKNOWN: Final = libusb1.LIBUSB_SPEED_UNKNOWN
SPEED_LOW: Final = libusb1.LIBUSB_SPEED_LOW
SPEED_FULL: Final = libusb1.LIBUSB_SPEED_FULL
SPEED_HIGH: Final = libusb1.LIBUSB_SPEED_HIGH
SPEED_SUPER: Final = libusb1.LIBUSB_SPEED_SUPER
SPEED_SUPER_PLUS: Final = libusb1.LIBUSB_SPEED_SUPER_PLUS
SPEED_SUPER_PLUS_X2: Final = libusb1.LIBUSB_SPEED_SUPER_PLUS_X2
LOW_SPEED_OPERATION: Final = libusb1.LIBUSB_LOW_SPEED_OPERATION
FULL_SPEED_OPERATION: Final = libusb1.LIBUSB_FULL_SPEED_OPERATION
HIGH_SPEED_OPERATION: Final = libusb1.LIBUSB_HIGH_SPEED_OPERATION
SUPER_SPEED_OPERATION: Final = libusb1.LIBUSB_5GBPS_OPERATION
SUCCESS: Final = libusb1.LIBUSB_SUCCESS
ERROR_IO: Final = libusb1.LIBUSB_ERROR_IO
ERROR_INVALID_PARAM: Final = libusb1.LIBUSB_ERROR_INVALID_PARAM
ERROR_ACCESS: Final = libusb1.LIBUSB_ERROR_ACCESS
ERROR_NO_DEVICE: Final = libusb1.LIBUSB_ERROR_NO_DEVICE
ERROR_NOT_FOUND: Final = libusb1.LIBUSB_ERROR_NOT_FOUND
ERROR_BUSY: Final = libusb1.LIBUSB_ERROR_BUSY
ERROR_TIMEOUT: Final = libusb1.LIBUSB_ERROR_TIMEOUT
ERROR_OVERFLOW: Final = libusb1.LIBUSB_ERROR_OVERFLOW
ERROR_PIPE: Final = libusb1.LIBUSB_ERROR_PIPE
ERROR_INTERRUPTED: Final = libusb1.LIBUSB_ERROR_INTERRUPTED
ERROR_NO_MEM: Final = libusb1.LIBUSB_ERROR_NO_MEM
ERROR_NOT_SUPPORTED: Final = libusb1.LIBUSB_ERROR_NOT_SUPPORTED
ERROR_OTHER: Final = libusb1.LIBUSB_ERROR_OTHER
TRANSFER_COMPLETED: Final = libusb1.LIBUSB_TRANSFER_COMPLETED
TRANSFER_ERROR: Final = libusb1.LIBUSB_TRANSFER_ERROR
TRANSFER_TIMED_OUT: Final = libusb1.LIBUSB_TRANSFER_TIMED_OUT
TRANSFER_CANCELLED: Final = libusb1.LIBUSB_TRANSFER_CANCELLED
TRANSFER_STALL: Final = libusb1.LIBUSB_TRANSFER_STALL
TRANSFER_NO_DEVICE: Final = libusb1.LIBUSB_TRANSFER_NO_DEVICE
TRANSFER_OVERFLOW: Final = libusb1.LIBUSB_TRANSFER_OVERFLOW
TRANSFER_SHORT_NOT_OK: Final = libusb1.LIBUSB_TRANSFER_SHORT_NOT_OK
TRANSFER_FREE_BUFFER: Final = libusb1.LIBUSB_TRANSFER_FREE_BUFFER
TRANSFER_FREE_TRANSFER: Final = libusb1.LIBUSB_TRANSFER_FREE_TRANSFER
TRANSFER_ADD_ZERO_PACKET: Final = libusb1.LIBUSB_TRANSFER_ADD_ZERO_PACKET
CAP_HAS_CAPABILITY: Final = libusb1.LIBUSB_CAP_HAS_CAPABILITY
CAP_HAS_HOTPLUG: Final = libusb1.LIBUSB_CAP_HAS_HOTPLUG
CAP_HAS_HID_ACCESS: Final = libusb1.LIBUSB_CAP_HAS_HID_ACCESS
CAP_SUPPORTS_DETACH_KERNEL_DRIVER: Final = libusb1.LIBUSB_CAP_SUPPORTS_DETACH_KERNEL_DRIVER
LOG_LEVEL_NONE: Final = libusb1.LIBUSB_LOG_LEVEL_NONE
LOG_LEVEL_ERROR: Final = libusb1.LIBUSB_LOG_LEVEL_ERROR
LOG_LEVEL_WARNING: Final = libusb1.LIBUSB_LOG_LEVEL_WARNING
LOG_LEVEL_INFO: Final = libusb1.LIBUSB_LOG_LEVEL_INFO
LOG_LEVEL_DEBUG: Final = libusb1.LIBUSB_LOG_LEVEL_DEBUG
LOG_CB_GLOBAL: Final = libusb1.LIBUSB_LOG_CB_GLOBAL
LOG_CB_CONTEXT: Final = libusb1.LIBUSB_LOG_CB_CONTEXT
OPTION_LOG_LEVEL: Final = libusb1.LIBUSB_OPTION_LOG_LEVEL
OPTION_USE_USBDK: Final = libusb1.LIBUSB_OPTION_USE_USBDK
OPTION_NO_DEVICE_DISCOVERY: Final = libusb1.LIBUSB_OPTION_NO_DEVICE_DISCOVERY
OPTION_LOG_CB: Final = libusb1.LIBUSB_OPTION_LOG_CB
OPTION_MAX: Final = libusb1.LIBUSB_OPTION_MAX
HOTPLUG_ENUMERATE: Final = libusb1.LIBUSB_HOTPLUG_ENUMERATE
HOTPLUG_EVENT_DEVICE_ARRIVED: Final = libusb1.LIBUSB_HOTPLUG_EVENT_DEVICE_ARRIVED
HOTPLUG_EVENT_DEVICE_LEFT: Final = libusb1.LIBUSB_HOTPLUG_EVENT_DEVICE_LEFT
HOTPLUG_NO_FLAGS: Final = libusb1.LIBUSB_HOTPLUG_NO_FLAGS
HOTPLUG_MATCH_ANY: Final = libusb1.LIBUSB_HOTPLUG_MATCH_ANY

USBError = libusb1.USBError

class USBErrorIO(USBError):
    value = libusb1.LIBUSB_ERROR_IO

class USBErrorInvalidParam(USBError):
    value = libusb1.LIBUSB_ERROR_INVALID_PARAM

class USBErrorAccess(USBError):
    value = libusb1.LIBUSB_ERROR_ACCESS

class USBErrorNoDevice(USBError):
    value = libusb1.LIBUSB_ERROR_NO_DEVICE

class USBErrorNotFound(USBError):
    value = libusb1.LIBUSB_ERROR_NOT_FOUND

class USBErrorBusy(USBError):
    value = libusb1.LIBUSB_ERROR_BUSY

class USBErrorTimeout(USBError):
    value = libusb1.LIBUSB_ERROR_TIMEOUT

class USBErrorOverflow(USBError):
    value = libusb1.LIBUSB_ERROR_OVERFLOW

class USBErrorPipe(USBError):
    value = libusb1.LIBUSB_ERROR_PIPE

class USBErrorInterrupted(USBError):
    value = libusb1.LIBUSB_ERROR_INTERRUPTED

class USBErrorNoMem(USBError):
    value = libusb1.LIBUSB_ERROR_NO_MEM

class USBErrorNotSupported(USBError):
    value = libusb1.LIBUSB_ERROR_NOT_SUPPORTED

class USBErrorOther(USBError):
    value = libusb1.LIBUSB_ERROR_OTHER

STATUS_TO_EXCEPTION_DICT: dict[int, type[USBError]] = {
    USBErrorIO.value: USBErrorIO,
    USBErrorInvalidParam.value: USBErrorInvalidParam,
    USBErrorAccess.value: USBErrorAccess,
    USBErrorNoDevice.value: USBErrorNoDevice,
    USBErrorNotFound.value: USBErrorNotFound,
    USBErrorBusy.value: USBErrorBusy,
    USBErrorTimeout.value: USBErrorTimeout,
    USBErrorOverflow.value: USBErrorOverflow,
    USBErrorPipe.value: USBErrorPipe,
    USBErrorInterrupted.value: USBErrorInterrupted,
    USBErrorNoMem.value: USBErrorNoMem,
    USBErrorNotSupported.value: USBErrorNotSupported,
    USBErrorOther.value: USBErrorOther,
}
